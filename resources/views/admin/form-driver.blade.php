                            ...
                            <form id="formTambahDriver">
                                <div class="flex flex-row gap-8 w-full p-6">
                                    <div class="flex flex-col gap-8 w-1/2">
                                        ...
                                        <input type="text"
                                            class="border-0 p-2 focus:ring-2 focus:ring-opacity-30 focus:ring-gray-500 shadow-md rounded-md w-full"
                                            name="merk" placeholder="Merk Kendaraan" required />
                                        <input type="text"
                                            class="border-0 p-2 focus:ring-2 focus:ring-opacity-30 focus:ring-gray-500 shadow-md rounded-md w-full"
                                            name="tipe_kendaraan" placeholder="Tipe Kendaraan" required />
                                        <input type="text"
                                            class="border-0 p-2 focus:ring-2 focus:ring-opacity-30 focus:ring-gray-500 shadow-md rounded-md w-full"
                                            name="warna_kendaraan" placeholder="Warna Kendaraan" required />
                                        <input type="text"
                                            class="border-0 p-2 focus:ring-2 focus:ring-opacity-30 focus:ring-gray-500 shadow-md rounded-md w-full"
                                            name="no_kendaraan" placeholder="No. Kendaraan" required />
                                    </div>
                                    <div class="flex flex-col gap-8 h-fit w-1/2">
                                        <input type="text"
                                            class="border-0 p-2 focus:ring-2 focus:ring-opacity-30 focus:ring-gray-500 shadow-md rounded-md w-full"
                                            name="no_sim" placeholder="No. SIM" required />
                                        <input type="text"
                                            class="border-0 p-2 focus:ring-2 focus:ring-opacity-30 focus:ring-gray-500 shadow-md rounded-md w-full"
                                            name="no_stnk" placeholder="No. STNK" required />
                                        <input type="password"
                                            class="border-0 p-2 focus:ring-2 focus:ring-opacity-30 focus:ring-gray-500 shadow-md rounded-md w-full"
